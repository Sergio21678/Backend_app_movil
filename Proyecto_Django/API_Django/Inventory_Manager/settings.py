...
SECRET_KEY = 'django-insecure-#p^89m4&mcojg18*k0wouffefun+ssjvy9xcrwyvz3z3g4p#1)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '192.168.0.249', '127.0.0.1','192.168.129.49']
...
INSTALLED_APPS = [
    ...
    'usuarios', # Include the app in the project
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Include the middleware in the project
